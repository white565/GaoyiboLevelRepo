...
Shader "TidalFlask/Triplanar Color Gradient Unlit URP"
{
	Properties
	{
		...
		[ASEEnd]_GradientFalloff("Gradient Falloff", Range( 0 , 10)) = 0.3
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float staticSwitch86 = WorldPosition.y;
				#else
...
/*ASEBEGIN
Version=18912
632;245;1744;1156;1198.977;353.5383;1.089349;True;False
...
ASEEND*/
//CHKSM=A9CBCE3A48DE4CC6397E711133B5435C1D11CDA4